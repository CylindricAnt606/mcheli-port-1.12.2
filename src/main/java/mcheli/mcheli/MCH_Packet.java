   ...
   extends W_PacketBase
 {
   ...
   public byte setBit(byte data, int bit, boolean b) { return (byte)(data | (b ? 1 : 0) << bit); }
   public short setBit(short data, int bit, boolean b) { return (short)(data | (b ? 1 : 0) << bit); }
   public boolean getBit(byte data, int bit) { return ((data >> bit & 0x1) != 0); } public boolean getBit(short data, int bit) {
     return ((data >> bit & 0x1) != 0);
   }
