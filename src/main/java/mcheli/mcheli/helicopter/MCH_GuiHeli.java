...
/*  30 */     return MCH_EntityAircraft.getAircraft_RiddenOrControl((Entity)player) instanceof MCH_EntityHeli;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 104 */     if (MCH_Config.HideKeybind.prmBool)
/*     */       return; 
/* 106 */     MCH_HeliInfo info = heli.getHeliInfo();
/* 107 */     if (info == null) {
/*     */       return;
/*     */     }
/*     */     
/* 111 */     int colorActive = -1342177281;
/* 112 */     int colorInactive = -1349546097;
/* 113 */     int RX = this.centerX + 120;
/* 114 */     int LX = this.centerX - 200;
/*     */     
/* 116 */     drawKeyBind((MCH_EntityAircraft)heli, (MCH_AircraftInfo)info, player, seatID, RX, LX, colorActive, colorInactive);
/*     */ 
/*     */ 
/*     */     
/* 120 */     if (seatID == 0 && info.isEnableGunnerMode) if (!Keyboard.isKeyDown(MCH_Config.KeyFreeLook.prmInt)) {
/*     */         
/* 122 */         int c = heli.isHoveringMode() ? colorInactive : colorActive;
/* 123 */         String msg = (heli.getIsGunnerMode((Entity)player) ? "Normal" : "Gunner") + " : " + MCH_KeyName.getDescOrName(MCH_Config.KeySwitchMode.prmInt);
/*     */         
/* 125 */         drawString(msg, RX, this.centerY - 70, c);
/*     */       } 
/*     */     
/* 128 */     if (seatID > 0 && heli.canSwitchGunnerModeOtherSeat(player)) {
/*     */       
/* 130 */       String msg = (heli.getIsGunnerMode((Entity)player) ? "Normal" : "Camera") + " : " + MCH_KeyName.getDescOrName(MCH_Config.KeySwitchMode.prmInt);
/*     */       
/* 132 */       drawString(msg, RX, this.centerY - 40, colorActive);
/*     */     } 
/*     */ 
/*     */     
/* 136 */     if (seatID == 0) if (!Keyboard.isKeyDown(MCH_Config.KeyFreeLook.prmInt)) {
/*     */         
/* 138 */         int c = heli.getIsGunnerMode((Entity)player) ? colorInactive : colorActive;
/* 139 */         String msg = (heli.getIsGunnerMode((Entity)player) ? "Normal" : "Hovering") + " : " + MCH_KeyName.getDescOrName(MCH_Config.KeySwitchHovering.prmInt);
/*     */         
/* 141 */         drawString(msg, RX, this.centerY - 60, c);
/*     */       } 
/*     */     
/* 144 */     if (seatID == 0)
/*     */     {
/* 146 */       if (heli.getTowChainEntity() != null && !(heli.getTowChainEntity()).field_70128_L) {
/*     */ 
/*     */         
/* 149 */         String msg = "Drop  : " + MCH_KeyName.getDescOrName(MCH_Config.KeyExtra.prmInt);
/* 150 */         drawString(msg, RX, this.centerY - 30, colorActive);
/*     */ 
/*     */ 
/*     */       
/*     */       }
/* 155 */       else if (info.isEnableFoldBlade && MCH_Lib.getBlockIdY(heli.field_70170_p, heli.field_70165_t, heli.field_70163_u, heli.field_70161_v, 1, -2, true) > 0 && heli.getCurrentThrottle() <= 0.01D) {
/*     */ 
/*     */ 
/*     */         
/* 159 */         String msg = "FoldBlade  : " + MCH_KeyName.getDescOrName(MCH_Config.KeyExtra.prmInt);
/* 160 */         drawString(msg, RX, this.centerY - 30, colorActive);
/*     */       } 
/*     */     }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 167 */     if ((heli.getIsGunnerMode((Entity)player) || heli.isUAV()) && info.cameraZoom > 1) {
/*     */ 
/*     */       
/* 170 */       String msg = "Zoom : " + MCH_KeyName.getDescOrName(MCH_Config.KeyZoom.prmInt);
/* 171 */       drawString(msg, LX, this.centerY - 80, colorActive);
/*     */     }
/* 173 */     else if (seatID == 0) {
/*     */       
/* 175 */       if (heli.canFoldHatch() || heli.canUnfoldHatch()) {
/*     */         
/* 177 */         String msg = "OpenHatch : " + MCH_KeyName.getDescOrName(MCH_Config.KeyZoom.prmInt);
/* 178 */         drawString(msg, LX, this.centerY - 80, colorActive);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              C:\Users\danie\Desktop\Mod Porting Tools\MC1.7.10_mcheli_1.0.3.jar!\mcheli\mcheli\helicopter\MCH_GuiHeli.class
